...
const Contact = () => {
  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div variants={slideIn('left', "tween", 0.2, 1)} className="flex-[0.75] p-8 rounded-2xl" style={{ background: 'rgba(174, 152, 105, 0.2)', backdropFilter: 'blur(3px)', boxShadow: '0 4px 10px rgba(0, 0, 0, 0.2)'}}>
